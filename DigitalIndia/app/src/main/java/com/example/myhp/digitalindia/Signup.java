...
/**
 * Created by my hp on 4/8/2016.
 */
public class Signup extends AppCompatActivity implements View.OnClickListener {
    String username, password, email, confirmpass, pno, name;
  //  ProgressDialog pd;
    long pnoi;
            ...
            case R.id.bsignup:
              /*  Class i = null;
               ...
               // pd.show();
                ...
                String url = "http://licensemarvel.esy.es/reg.php";
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                               // pd.hide();
                                ...
                                Class i = null;
                                try {
                                    i = Class.forName("com.example.myhp.digitalindia.Login");
                                } catch (ClassNotFoundException e) {
                                    e.printStackTrace();
                                }
                                Intent k = new Intent(getApplicationContext(), i);
